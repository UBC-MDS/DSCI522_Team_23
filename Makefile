...
## Data preprocessing
data/winequality-train.csv data/winequality-test.csv  : src/Preprocessing.py data/winequality-red.csv data/winequality-white.csv 
...
results/knn_prediction.png results/knn_results.csv results/model_comparison.csv results/ridge_prediction.png results/ridge_results.csv results/test_set_result.csv : src/ML_analyses.py data/winequality-train.csv data/winequality-test.csv
	python src/ML_analyses.py data/winequality-train.csv data/winequality-test.csv

## Report

doc/wine_quality_predict_report.html : doc/wine_quality_predict_report.Rmd results/knn_prediction.png results/knn_results.csv results/model_comparison.csv results/ridge_prediction.png results/ridge_results.csv results/test_set_result.csv
...
clean :
    ...
    rm -rf results/quality_all_variables.png results/quality_count.png results/knn_prediction.png results/knn_results.csv results/model_comparison.csv results/ridge_prediction.png results/ridge_results.csv results/test_set_result.csv 
